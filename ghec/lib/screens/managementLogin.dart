...
class AfterManagementlogin extends StatefulWidget {
  final String teacherId;
  final String image;
  final String username;

  const AfterManagementlogin({
    super.key,
  ...
  @override
  State<AfterManagementlogin> createState() => _AfterManagementloginState();
}

class _AfterManagementloginState extends State<AfterManagementlogin> {
  void logout() {
