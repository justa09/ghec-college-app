...
class AfterHodlogin extends StatefulWidget {
  final String teacherId = "1";
  final String image ="";
  final String username ="101";

  const AfterHodlogin({super.key});



  @override
  State<AfterHodlogin> createState() => _AfterHodloginState();
}

class _AfterHodloginState extends State<AfterHodlogin> {
  void logout() {
